        ...
        <div className='parent-block'>
          ...
          <div className='card'>
            <div className="welcome-text">      
              ...
              <h3>Made by scientists, for scientists</h3>
              <p>Stay informed effortlessly</p>
            </div>
            </div>
          </div>
        </div>
